...
import br.com.meubancodigitaljdbc.adapters.output.dao.RowMapper.ClienteRowMapper;
...
public class ClienteDAO implements ClienteRepositoryPort {
    ...
    public Cliente save(Cliente cliente) throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            stmt.registerOutParameter(13, java.sql.Types.BIGINT);

            stmt.executeUpdate();

            long idGerado = stmt.getLong(13);
